...
<body>
    ...
    <div class="bg-color-b7854a">
        <div class="container  pre-padding">
            <div class="bangTag">
                <a href="<?php echo $url ?>">HOME</a> <span> / ABSTRACT SUBMISSION</span>
            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row g-2 was-validated">
                                <select class="form-select" onchange="handleLink(value)" style="display: none;">
                                    <option selected disabled value="">Select....</option>
                                    <option value="full paper">I want to submit a full paper</option>
                                    <option value="abstract only">I want to submit abstract only</option>
                                </select>
    ...
    <script src="js/abstract-select.js"></script>
</body>
