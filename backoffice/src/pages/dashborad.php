                        ...
                        <div class="col-md-4 col-12">
                            <div class="card card-outline card-success">
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <button class="btn btn-success w-100">ดูข้อมูล</button>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 col-12">
                            <div class="card card-outline card-danger">
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <button class="btn btn-danger w-100">ดูข้อมูล</button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row g-2">
                    <div class="col-md-4 col-12">
                        <div class="card card-outline card-secondary">
                            ...
                            <div class="card-body text-center">
                                <h1 class="text-secondary">10</h1>
                                <button class="btn btn-secondary w-100">ดูข้อมูล</button>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-12">
                        <div class="card card-outline card-info">
                            ...
                            <div class="card-body text-center">
                                ...
                                <button class="btn btn-info w-100">ดูข้อมูล</button>
                            </div>
                        </div>
                    </div>
                </div>
